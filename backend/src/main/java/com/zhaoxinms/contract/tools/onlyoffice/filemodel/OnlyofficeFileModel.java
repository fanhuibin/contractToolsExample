...
@Getter
@Setter
public class OnlyofficeFileModel { // the file base parameters which include the platform type used, document
                                   // display size (width and height) and type of the document opened
    @Autowired
    ...
    @Autowired
    private EditorConfig editorConfig; // the parameters pertaining to the editor interface: opening mode (viewer or
