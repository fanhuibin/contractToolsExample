...
import com.zhaoxinms.contract.tools.onlyoffice.AbstractModel;
...
public class Permission extends AbstractModel { // the permission for the document to be edited and downloaded or not
    ...
    private Boolean modifyFilter = true; // if the filter can applied globally (true) affecting all the other users, or
                                         // locally (false)
