...
/**
 * Disables and enables certificate and host-name checking in HttpsURLConnection, the default JVM implementation of the
 * HTTPS/TLS protocol. Has no effect on implementations such as Apache Http Client, Ok Http.
 */
@Component
