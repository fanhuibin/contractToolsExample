...
// embedded.setEmbedUrl(url); // set the embedURL parameter to the embedded config (the absolute URL to the document
/// serving as a source file for the document embedded into the web page)
// embedded.setSaveUrl(url); // set the saveURL parameter to the embedded config (the absolute URL that will allow the
/// document to be saved onto the user personal computer)
// embedded.setShareUrl(url); // set the shareURL parameter to the embedded config (the absolute URL that will allow
/// other users to share this document)
// embedded.setToolbarDocked(ToolbarDocked.top); // set the top toolbarDocked parameter to the embedded config (the
/// place for the embedded viewer toolbar, can be either top or bottom)
// };
// }
// }
