...
import com.zhaoxinms.contract.tools.onlyoffice.filemodel.Document;
import com.zhaoxinms.contract.tools.onlyoffice.filemodel.Permission;
import com.zhaoxinms.contract.tools.onlyoffice.services.configurers.DocumentConfigurer;
...
public class DefaultDocumentConfigurer implements DocumentConfigurer<DefaultDocumentWrapper> {
    ...
    public void configure(Document document, DefaultDocumentWrapper wrapper) { // define the document configurer
        ...
        document.setUrl(wrapper.getUrl()); // set the URL to download a file to the document config
        ...
        document.setFileType(fileUtility.getFileExtension(fileName).replace(".", "")); // set the file type to the
                                                                                       // document config
        // document.getInfo().setFavorite(wrapper.getFavorite()); // set the favorite
        // parameter to the document config
