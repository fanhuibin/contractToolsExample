...
var xJar = XJar{
	md5:  []byte{227, 102, 7, 27, 1, 234, 88, 255, 222, 110, 248, 185, 127, 182, 133, 169},
	sha1: []byte{173, 238, 62, 192, 238, 93, 176, 203, 149, 202, 238, 2, 37, 208, 229, 239, 251, 84, 222, 169},
}
...
var xKey = XKey{
	...
	password:  []byte{122, 104, 97, 111, 120, 105, 110, 109, 115, 80, 115, 100},
}
