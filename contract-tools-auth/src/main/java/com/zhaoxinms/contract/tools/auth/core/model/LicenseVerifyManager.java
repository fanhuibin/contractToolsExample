...
import com.zhaoxinms.contract.tools.auth.core.helper.ParamInitHelper;
import com.zhaoxinms.contract.tools.auth.core.utils.DateUtils;
...
//          LicenseManager licenseManager =new LicenseManager(licenseParam);
            ...
            /** 3、获取要安装的证书文件 */
            LoggerHelper.info("证书地址："+param.getLicensePath());
